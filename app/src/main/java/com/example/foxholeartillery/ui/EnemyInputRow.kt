    ...
    Column(modifier) {
        ...
        Row(
            ...
            NumberInput(
                ...
                value = screenState.enemyDistanceInput,
                onNumberChange = {
                    presenter.onInput(CalculatorAction.EnemyDistanceInput(it))
                }
            )
            ...
            NumberInput(
                ...
                value = screenState.enemyAzimuthInput,
                onNumberChange = {
                    presenter.onInput(CalculatorAction.EnemyAzimuthInput(it))
                }
            )
        }
    }
